...
import VERT_SHADER from "../shader/LookAtTriangles.vert!text";
import FRAG_SHADER from "../shader/LookAtTriangles.frag!text";
var $canvas = $("#canvas");
var $tools = $("#tools");
...
var eyeXSlider = new Slider(100, 200, -1, 1, 0.20, "eye x");
var eyeYSlider = new Slider(100, 350, -1, 1, 0.25, "eye y");
var eyeZSlider = new Slider(100, 500, -1, 1, 0.25, "eye z");
