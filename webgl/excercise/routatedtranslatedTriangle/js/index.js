...
import VERT_SHADER from "../shader/routatedtranslatedTriangle.vert!text";
import FRAG_SHADER from "../shader/routatedtranslatedTriangle.frag!text";
var $canvas = $("#canvas");
var $tools = $("#tools");
...
var posXSlider = new Slider(100, 200, -1, 1, 0.5, "pos x");
...
drawAnimation(()=>{
	...
	// xformMatrix.translate(posXSlider.getValue(), posYSlider.getValue(), 0);
	// xformMatrix.setTranslate(posXSlider.getValue(), posYSlider.getValue(), posZSlider.getValue());
	// xformMatrix.rotate(angleSlider.getValue(), 0, 0, 1);
	xformMatrix.setRotate(angleSlider.getValue(), 0, 0, 1);
